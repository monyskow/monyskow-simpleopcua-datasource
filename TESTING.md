...
**Test coverage**: 46+ tests across plugin metadata, configuration, query editor, data queries, and cross-version compatibility.
...
Expected: All 46 tests pass across smoke, configuration, query editor, and data query suites.
